...
Creates the custom User model and UserProfile.
"""
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_notifications', models.BooleanField(default=True, help_text='Receive email notifications for task updates', verbose_name='email notifications')),
