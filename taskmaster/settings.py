...
A comprehensive task management system to learn Django with Redis integration.
"""
...
DATABASES = {
    'default': {
        ...
        'USER': config('DB_USER', default='taskmaster_user'),
        'PASSWORD': config('DB_PASSWORD', default='taskmaster_pass'),
